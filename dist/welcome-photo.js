...
home=function(){
 ...
 const hero=`<section class="photo-welcome"><img class="welcome-photo" src="assets/service-table.jpg" alt="" fetchpriority="high" decoding="async"><div class="photo-welcome-copy"><h1>${txt(T('Dein erster Service.','Your first service.','Vos premiers pas en salle.'))}</h1><p>${txt(T('Lerne, Gerichte zu erklären, Getränke zu empfehlen und deine Gäste aufmerksam zu begleiten.','Learn to explain dishes, recommend drinks and look after your guests.','Apprenez à présenter les plats, à conseiller les boissons et à prendre soin des convives.'))}</p><a class="primary welcome-start" href="#${returning?'journey':'lesson/welcome'}">${txt(returning?T('Weiterlernen','Continue learning','Continuer'):FLOW.start)}${arrow}</a></div></section>`;
